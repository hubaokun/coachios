...
@interface ScheduleDetailViewController ()<UITableViewDataSource, UITableViewDelegate, CustomTabBarDelegate>
{
    BOOL isCloseDate;
    CGRect dateFrame;
    BOOL isShowCalendar;
...
- (void)viewDidLoad {
    ...
    self.dateLabel.text = [CommonUtil getStringForDate:self.nowDate format:@"yyyy年MM月dd日"];
    isCloseDate = NO;
    isShowCalendar = YES;
...
- (void)clickForChoose:(DateButton *)button{
    ...
    [self.mainTableView reloadRowsAtIndexPaths:@[[NSIndexPath indexPathForRow:button.tag inSection:0]] withRowAnimation:UITableViewRowAnimationNone];
}
...
//    [self.calenderDic setObject:dic forKey:chooseTime];
//    
//    [self.mainTableView reloadRowsAtIndexPaths:@[[NSIndexPath indexPathForRow:button.tag inSection:0]]  withRowAnimation:UITableViewRowAnimationFade];
//    
////    [self checkSlideDown];
//}
